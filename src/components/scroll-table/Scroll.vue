...
import * as utilsMethods from "@/utils/scroll";
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const wrap = templateRef("wrap", null);
    const slotList = templateRef("slotList", null);
    const realBox = templateRef("realBox", null);
